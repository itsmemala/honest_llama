...
def main(): 
    ...
    with open(f'{args.save_path}/responses/{args.model}_gsm8k_sampled_responses_train5000.json', 'r') as read_file:
    ...
    with open(f'{args.save_path}/responses/{args.model}_gsm8k_sampledplus_responses_train5000.json', 'w') as f:
