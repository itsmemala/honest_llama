...
# ]
# labels = ['linear_last_layer','tfmr_all_layers','tfmr_all_layers_dist','tfmr_supcon','tfmr_supcon_dist','tfmr_supcon+','tfmr_supcon+*','tfmr_supcon+*_dist']
...
fig.savefig(f'{save_path}/fpr_at_recall_curves/llama_trivia_partial_fpr_at_recall.png')
# fig.savefig(f'{save_path}/fpr_at_recall_curves/llama_nq_partial_fpr_at_recall.png')
# fig.savefig(f'{save_path}/fpr_at_recall_curves/alpaca_trivia_partial_fpr_at_recall.png')
# fig.savefig(f'{save_path}/fpr_at_recall_curves/alpaca_nq_partial_fpr_at_recall.png')
