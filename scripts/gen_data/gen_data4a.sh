...
python get_prompt_responses_factual.py gemma_2B gsm8k --len_dataset 5000 --start_at 0 --use_split train --device 0 --save_path /home/local/data/ms/honest_llama_data --do_sample True --num_ret_seq 10
...
python get_activations.py gemma_2B gsm8k --token answer_last --file_name gsm8k_sampledplus_responses_train5000  --device 0 --save_path /home/local/data/ms/honest_llama_data --num_samples 11
