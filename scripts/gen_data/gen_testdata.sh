...
# python get_activations.py vicuna_7B nq_open --token answer_last --file_name nq_open_sampled_responses_validation1800  --device 0 --save_path /content/gdrive/MyDrive/honest_llama --num_samples 10
