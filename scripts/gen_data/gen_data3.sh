...
# python get_activations.py hl_llama_7B strqa --token answer_last --file_name strqa_dola_0to16_responses_test  --device 0 --save_path /home/local/data/ms/honest_llama_data