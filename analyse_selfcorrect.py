...
def main():
    ...
    greedy_labels = []
    with open(args.greedy_responses_labels_file_name, 'r') as read_file:
        for line in read_file:
            greedy_labels.append(json.loads(line))
    sc_labels = []
    with open(args.sc_responses_labels_file_name, 'r') as read_file:
        for line in read_file:
            sc_labels.append(json.loads(line))
    sc_responses = []
    with open(args.sc_responses_file_name, 'r') as read_file:
        for line in read_file:
