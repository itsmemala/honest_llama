...
def main(): 
    ...
    elif 'gsm8k' in args.test_file_name or 'strqa' in args.test_file_name or 'dola' in args.test_file_name:
                    ...
                    for lr in lr_search_list:
                        ...
                        for cce_lr in args.cce_lr_list:
                            ...
                            if len(args.dataset_list)==1 and args.ood_test==False:
                                ...
                                if 'dola' in args.test_file_name: probes_file_name = f'T{save_seed}_/{args.model_name}_/ood_{train_dataset_name}/_{args.test_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}{args.norm_input}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.use_class_wgt}'
                            ...
                            print('probes_file_name:',probes_file_name)
