...
def main(): 
    ...
    uncertainties = np.save(f'{args.save_path}/uncertainty/{args.model_name}_{args.dataset_name}_{args.file_name}_uncertainty_scores.npy')
    ...
    for row_index in range(avg_nll.shape[0]):
        ...
        semantic_set_ids_row = all_semantic_set_ids[row_index]
