...
def main(): 
    ...
    with open(f'{args.save_path}/responses/hl_llama_7B_nq_open_sampled_responses_train5000.json', 'r') as read_file:
        for line in read_file:
            sampled_resp_data.append(json.loads(line))
    ...
    with open(f'{args.save_path}/responses/hl_llama_7B_nq_open_sampledplus_responses_train5000.json', 'w') as outfile:
    ...
    sampled_labels_data = []
    with open(f'{args.save_path}/responses/hl_llama_7B_nq_open_sampled_responses_labels_train2000.json', 'r') as read_file:
        for line in read_file:
            sampled_labels_data.append(json.loads(line))
    with open(f'{args.save_path}/responses/hl_llama_7B_nq_open_sampled_responses_labels_train5000.json', 'r') as read_file:
        for line in read_file:
            sampled_labels_data.append(json.loads(line))
    for i,s_row in enumerate(sampled_resp_data):
        greedy_i = ''
    ...
    with open(f'{args.save_path}/responses/hl_llama_7B_nq_open_sampledplus_responses_labels_train5000.json', 'w') as outfile:
