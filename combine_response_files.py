...
def main(): 
    ...
    response_data = []
    for end in ['']:
        with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_greedy_responses_train5000.json', 'r') as read_file:
    ...
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_baseline_responses_train.json', 'w') as outfile:
        json.dump(train.to_dict(orient='list'), outfile)
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_baseline_responses_test.json', 'w') as outfile:
    ...
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_baseline_responses_train.json', 'r') as read_file:
        train_data = json.load(read_file)
    train_data_pd = pd.DataFrame.from_dict(train_data)
    # print(len(train_data_pd))
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_baseline_responses_test.json', 'r') as read_file:
        test_data = json.load(read_file)
    test_data_pd = pd.DataFrame.from_dict(test_data)
    # print(len(test_data_pd))
    # print(train_data_pd[:2])
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_sampled_responses_train5000.json', 'r') as read_file:
        response_data = json.load(read_file)
    response_data_pd = pd.DataFrame.from_dict(response_data)
    response_data_pd['index'] = response_data_pd.index
    ...
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_sampled_responses_train.json', 'w') as outfile:
        json.dump(train.to_dict(orient='list'), outfile)
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_sampled_responses_test.json', 'w') as outfile:
        json.dump(test.to_dict(orient='list'), outfile)

    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_baseline_responses_train.json', 'r') as read_file:
        greedy_train_data = json.load(read_file)
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_sampled_responses_train.json', 'r') as read_file:
        sampled_train_data = json.load(read_file)
    ...
    with open(f'{args.save_path}/responses/llama3.1_8B_Instruct_strqa_sampledplus_responses_train.json', 'w') as f:
