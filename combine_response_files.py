...
def main(): 
    ...
    # strqa
    with open(f'{args.save_path}/responses/hl_llama_7B_gsm8k_sampledplus_responses_train5000.json', 'r') as read_file:
    ...
    with open(f'{args.save_path}/responses/hl_llama_7B_gsm8k_sampledplussl_responses_train5000.json', 'w') as f:
