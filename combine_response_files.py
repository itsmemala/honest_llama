...
def main(): 
    ...
    ### update labels ###
    sampled_labels_data = []
    with open(f'{args.save_path}/responses/alpaca_7B_trivia_qa_sampledplus_responses_labels_train5000.json', 'r') as read_file:
    ...
    with open(f'{args.save_path}/responses/alpaca_7B_trivia_qa_sampledplussl_responses_labels_train5000.json', 'w') as outfile:
