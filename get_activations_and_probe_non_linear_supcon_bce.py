            ...
            for seed_itr,save_seed in enumerate(args.seed_list):
                ...
                for lr in args.lr_list:
                    ...
                    if len(args.dataset_list)==1 and args.ood_test==False:
                        ...
                        probes_file_name = f'NLSC{save_seed}_/{args.model_name}_/multi_/{test_dataset_name}_{args.num_folds}_{args.using_act}{args.norm_input}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.use_class_wgt}'
                    elif args.ood_test:
