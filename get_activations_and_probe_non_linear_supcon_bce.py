    ...
    for lr in args.lr_list:
        ...
        for save_seed in args.seed_list:
            ...
            if args.dataset_list is None and args.ood_test==False:
                ...
                probes_file_name = f'NLSC{save_seed}_{args.model_name}_ood_{train_dataset_name}_{test_dataset_name}_{args.num_folds}_{args.using_act}{args.norm_input}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.use_class_wgt}'
