...
def main(): 
            ...
            for head in loop_heads:
                ...
                for epoch in range(args.epochs):
                    ...
                    for step,batch in enumerate(ds_train):
                        ...
                        print(torch.mean(inputs, dim=-1).sum()==0)
    ...
    np.save(f'{args.save_path}/probes/NLSC{save_seed}_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.use_class_wgt}_val_auc.npy', all_val_auc)
