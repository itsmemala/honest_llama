...
def main():
    ...
    for fold in range(len(all_test_f1s)):
        ...
        for model in range(all_test_logits[fold].shape[0]):
            ...
            #
            test_pred_model = all_test_pred[fold][model]
            test_pred_model[test_pred_model>0.5] = 1
            test_pred_model[test_pred_model<=0.5] = 0
            cls1_f1 = f1_score(all_test_true[fold][0],test_pred_model)
            cls0_f1 = f1_score(all_test_true[fold][0],test_pred_model,pos_label=0)
