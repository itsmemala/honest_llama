...
def main(): 
    ...
    parser.add_argument('--method',type=str, default='individual_non_linear')
        ...
        for layer in tqdm(range(num_layers)):
            ...
            for head in loop_heads:
                if args.method=='individual_non_linear':
                    ...
                    ds_train = DataLoader(ds_train, batch_size=args.bs, shuffle=True)
                    ...
                    named_params = list(linear_model.named_parameters())
                    ...
                    with torch.no_grad():
                        ...
                        for step,batch in enumerate(ds_val):
                            ...
                            if args.token in ['answer_last','prompt_last','maxpool_all']: val_logits.append(linear_model(inputs))
                            if args.token in ['all','tagged_tokens']: val_logits.append(torch.stack([torch.max(linear_model(inp).data, dim=0)[0] for inp in inputs]))
    ...
    np.save(f'{args.save_path}/probes/NL_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.optimizer}_{args.use_class_wgt}_{args.layer_start}_{args.layer_end}_val_loss.npy', all_val_loss)
    ...
    np.save(f'{args.save_path}/probes/NL_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.optimizer}_{args.use_class_wgt}_{args.layer_start}_{args.layer_end}_train_loss.npy', all_train_loss)
    all_val_preds = np.stack([np.stack(all_val_preds[i]) for i in range(args.num_folds)])
    np.save(f'{args.save_path}/probes/NL_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.optimizer}_{args.use_class_wgt}_{args.layer_start}_{args.layer_end}_val_pred.npy', all_val_preds)
    ...
    np.save(f'{args.save_path}/probes/NL_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.optimizer}_{args.use_class_wgt}_{args.layer_start}_{args.layer_end}_val_f1.npy', all_val_f1s)
    all_test_f1s = np.stack([np.array(all_test_f1s[i]) for i in range(args.num_folds)])
    np.save(f'{args.save_path}/probes/NL_{args.model_name}_{args.train_file_name}_{args.len_dataset}_{args.num_folds}_{args.using_act}_{args.token}_{method_concat}_bs{args.bs}_epochs{args.epochs}_{args.lr}_{args.optimizer}_{args.use_class_wgt}_{args.layer_start}_{args.layer_end}_test_f1.npy', all_test_f1s)
