...
def main(): 
    ...
    for i in range(args.num_fold):
        ...
        if args.type_probes=='ind':
            ...
            probes, curr_fold_results, cur_y_val_pred, cur_y_val = train_probes(args.seed, train_set_idxs, val_set_idxs, separated_head_wise_activations, separated_labels, num_layers, num_heads, args.type_probes)
            ...
            probe, curr_fold_results, y_val_pred, y_val = train_ah_single_probe(args.seed, train_set_idxs, val_set_idxs, separated_head_wise_activations, separated_labels, num_layers, num_heads)
    ...
    if args.type_probes=='vote_on_ind' or args.type_probes=='single':
        ...
        np.save(f'{args.save_path}/probes/{args.model_name}_{args.dataset_name}_{args.num_fold}_{args.type_probes}_ah_probe_true.npy', all_y_val)
